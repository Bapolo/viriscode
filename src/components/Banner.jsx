...
function Banner() {
    ...
    return (
        <section className="py-4 px-4 mb-10 flex flex-col text-center items-center text-gray-700 rounded-md" style={{boxShadow: "0 4px 4px -2px rgba(0, 0, 0, 0.2)"}}>
                <p className="my-6 font-light text-md uppercase">Soluções digitais que movem negócios</p>

                <h2 className="text-4xl capitalize font-medium mb-6 text-gray-900 md:max-w-[65%]">A presença da sua Empresa na Web potencializa a versatilidade do seu negócio</h2>
